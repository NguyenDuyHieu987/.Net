    ...
    public partial class frmdangnhap : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Con.ConnectionString = "Data Source = DOMDOM\\SQLEXPRESS; Initial Catalog = QLNS; Integrated Security = SSPI";
                //Con.ConnectionString = "Server = DOMDOM\SQLEXPRESS; Database = QLNS; Integrated Security = True; user id = sa; password = hieusen123";
                Con.Open();
