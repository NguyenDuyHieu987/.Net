...
namespace QLNS
{
    class Clsdatabase
    {
        string strconnect = "Data Source = DOMDOM\\SQLEXPRESS; Initial Catalog = QLNS; Integrated Security = SSPI";
        //string strconnect = "Server = DOMDOM\SQLEXPRESS; Database = QLNS; Integrated Security = True; user id = sa; password = hieusen123";
